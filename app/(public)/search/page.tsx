    ...
    <main className="min-h-screen bg-bg-primary text-text-primary pt-10 pb-20 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="mb-12 text-center">
          <p className="text-accent font-mono text-sm mb-4 uppercase tracking-widest">
            {copy.results}
          </p>
          ...
          <p className="text-text-muted text-lg">
            {posts.length} {posts.length === 1 ? copy.story : copy.stories}{" "}
            {copy.found}
          </p>
        </div>
        ...
        {posts.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center space-y-6">
            ...
            <div className="max-w-md space-y-2">
              ...
              <p className="text-text-muted">{copy.noStoriesBody}</p>
            </div>
            <Link
              href="/topics"

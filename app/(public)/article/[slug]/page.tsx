    ...
    return (
        <main className="min-h-screen bg-bg-primary selection:bg-bg-inverse selection:text-text-inverse">
            <article className="pb-20">
                ...
                <div id="article-content" className="max-w-[1440px] mx-auto px-6 md:px-16 2xl:px-32 mt-12 md:mt-20 flex flex-col lg:flex-row gap-12 2xl:gap-24 relative scroll-mt-20">

...
def verify_admin_dashboard():
    with sync_playwright() as p:
        ...
        page.screenshot(path="verification/dashboard_articles.png")
        print("Screenshot saved: verification/dashboard_articles.png")
        ...
        if count > 0:
            ...
            page.screenshot(path="verification/edit_page.png")
            print("Screenshot saved: verification/edit_page.png")

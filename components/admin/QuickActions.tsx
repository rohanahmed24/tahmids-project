        ...
        {actions.map((action, index) => {
          ...
          return (
            ...
            >
              <Link
                href={action.href}
                className={`group flex flex-col items-center align-middle min-w-[100px] sm:min-w-0
              ...
              >
                <div
                  className={`p-2.5 mt-4 sm:p-3 rounded-xl text-white transition-all duration-300
                ...
                <h3
                  className="font-medium text-text-primary text-xs sm:text-sm text-center mt-2.5 sm:mt-3 mb-0.5 sm:mb-1
                ...
                <div
                  className="hidden lg:flex items-center justify-center mt-2 opacity-0 group-hover:opacity-100
